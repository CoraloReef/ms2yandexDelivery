<form class="form-horizontal ms2_form" id="msOrder" method="post">
        ...
        <div class="col-md-6" id="deliveries">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <button class="btn" type="button" data-ydwidget-open>Выбрать способ доставки</button>
                    <div id="ydwidget" class="yd-widget-modal"></div>
                    <p id="delivery_description" class="text-center"></p>
    ...
    <div class="well">
        <div class="col-md-offset-2">
            ...
            <button type="submit" name="ms2_action" value="order/submit" class="btn btn-default btn-primary ms2_link" data-ydwidget-createorder>
                {'ms2_frontend_order_submit' | lexicon}
            </button>
        </div>
    </div>

    <input type="hidden" name="delCostValue" id="delCostValue">
</form>
